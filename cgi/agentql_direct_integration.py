...
class EnhancedAIChat:
    """增强AI聊天，支持直接AgentQL API"""
    
    def __init__(self, use_real_api: bool = False):
        if use_real_api:
            self.agentql_client = DirectAgentQLClient()
        else:
...
if __name__ == "__main__":
    # 测试直接API集成
    enhanced_chat = EnhancedAIChat(use_real_api=False)  # 使用模拟数据
